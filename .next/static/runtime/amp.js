...
function tryApplyUpdates() {
  var res, _data, curPage, pageUpdated, _t;
  return _regeneratorAsync(function (_context) {
    while (1) switch (_context.p = _context.n) {
      ...
      case 1:
        _context.p = 1;
        _context.n = 2;
        return _awaitAsyncGenerator((0, _unfetch["default"])("" + hotUpdatePath + curHash + ".hot-update.json"));
      case 2:
        res = _context.v;
        _context.n = 3;
        return _awaitAsyncGenerator(res.json());
      case 3:
        _data = _context.v;
      ...
      case 4:
        _context.p = 4;
        _t = _context.v;
        console.error('Error occurred checking for update', _t);
        document.location.reload(true);
      case 5:
        return _context.a(2);
    }
  }, null, null, [[1, 4]], Promise);
}
